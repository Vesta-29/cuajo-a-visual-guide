  ...
  const suits = [
    {
      ...
      label: "Copas (Cups)",
      icon: "🏆",
      desc: "Cups symbolize the clergy or the church.",
    },
    {
      id: "Oros",
      label: "Oros (Coins)",
      icon: "🪙",
      desc: "Coins represent commerce and wealth.",
    },
    {
      id: "Espadas",
      label: "Espadas (Swords)",
      icon: "⚔️",
      desc: "Swords signify the military.",
    },
    {
      id: "Bastos",
      label: "Bastos (Clubs)",
      icon: "🌿",
      desc: "Batons stand for agriculture and the peasantry.",
    },
  ];
  ...
  return (
    <section id="section-01" className="mb-16 scroll-mt-24">
      <SectionHeader
        ...
        subtitle={
          <>
            The Filipino Spanish deck has{" "}
            <span style={{ color: "#E06A7D" }}>four suits </span>{" "}
            <strong>
              - Oros (Coins), Kopas (Cups), Espadas (Swords), and Bastos (Clubs)
            </strong>{" "}
            and 12 ranks. The <strong>face cards</strong> are{" "}
            <strong>
              Sota (Jack), Kabayo (Knight or Horse), and Hari (King)
            </strong>
            , which count as 10, 11, and 12. In the Cuajo version, this deck is
            expanded to 112 cards by using only{" "}
            <span style={{ color: "#E06A7D" }}>seven ranks</span>{" "}
            <strong>(Ace, 3, 4, 5, Jack, Horse, King)</strong> in each suit,
            with four copies of every card.
          </>
        }
      />
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start relative">
          ...
          <div className="flex-1 flex flex-col gap-10 w-full bg-white/40 p-3 sm:p-6 md:p-8 lg:p-12 rounded-lg border border-stone-300 shadow-sm backdrop-blur-sm">
            {suits
              ...
              .map((suit) => (
                <div
                  key={suit.id}
                  className="flex flex-col 2xl:flex-row items-start 2xl:items-center gap-6 2xl:gap-12 pb-12 border-b border-stone-200 last:border-0 last:pb-0"
                >
          ...
          {/* Hover Preview Panel */}
          <div className="hidden lg:flex w-full lg:!w-[291px] lg:!min-w-[291px] lg:!max-w-[291px] shrink-0 lg:sticky lg:top-24 bg-stone-800 border border-stone-700 rounded-lg p-6 shadow-2xl min-h-[400px] max-h-[400px] flex-col items-center justify-center overflow-hidden">
            {hoveredCard ? (
              <div className="flex flex-col items-center gap-6 animate-in fade-in zoom-in duration-200 w-full">
                ...
                <div className="text-center w-full">
                  ...
                  <p className="text-sm text-stone-400 mt-2 break-words leading-relaxed">
                    {hoveredCard.desc}
                  </p>
                  {!hoveredCard.active && (
