...
const Scoring = () => {
  const payoutTiers = [
    {
      type: "Ideal Bunot",
      condition: "Self-drawn from stock (Coincides with Mahjong concept)",
      amount: "$1.10",
    },
    {
      type: "Sowee Bonus",
      condition: 'Possess Sowee card + 2 cards that "go with" it',
      amount: "70¢",
    },
    {
      type: "Bunot Bonus",
      condition: 'Possess 2 cards that "go with" the bunot (winning card)',
      amount: "60¢",
    },
    {
      type: "Basic Win",
      condition: "Standard win with no special conditions met",
      amount: "20¢",
    },
  ];
  ...
  return (
    <section id="section-04" className="mb-16 scroll-mt-24">
      ...
      <div className="bg-[#FDFCF9] border border-stone-200 rounded-2xl p-5 sm:p-8 md:p-12 mb-14 shadow-sm overflow-hidden relative">
        <div className="mb-10">
          <h4 className="text-3xl font-serif text-stone-800 flex items-baseline gap-2">
            Example Winning Hand <span className="text-stone-400">·</span>{" "}
            <span style={{ color: RED }} className="italic">
              Bahay
            </span>
          </h4>
          <p className="text-stone-500 text-sm mt-2 max-w-2xl leading-relaxed">
            A complete 16-card hand organized into distinct combinations. All
            cards must be accounted for in a valid set or sequence.
          </p>
        </div>
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="flex gap-1">
                ...
                <CuajoCard
                  suit="Bastos"
                  value="King"
                  className="!w-16 sm:!w-20 border-2 border-[#E06A7D] shadow-xl z-10"
                />
              </div>
              <p className="text-[9px] font-black tracking-widest text-stone-400 uppercase">
                Escalera · Bastos (Bunot)
              </p>
            </div>
          </div>
          ...
          <div className="w-full pt-10 mt-6 border-t border-dashed border-stone-200 flex flex-col items-center gap-4">
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-stone-800">
              <div className="text-center">
                ...
                <div className="text-[9px] font-black uppercase tracking-tighter text-stone-400">
                  Cards Total
                </div>
              </div>
              ...
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-serif font-bold text-stone-800">
                  5{" "}
                  <span className="text-xs sm:text-sm italic font-normal text-stone-500">
                    sets
                  </span>
                </div>
                <div className="text-[9px] font-black uppercase tracking-tighter text-stone-400">
      ...
      {/* Two-column info card — Extra Ways to Earn and What "Goes With" */}
      <div className="bg-white/60 border border-stone-300 rounded-xl p-6 sm:p-8 md:p-10 lg:p-12 xl:p-14 2xl:p-16 mb-14 grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-10 items-center backdrop-blur-sm shadow-sm">
        <div>
          <p
            className="text-[13px] font-black tracking-[0.2em] uppercase mb-3"
        ...
        <div>
          ...
          <p className="text-sm text-stone-600 leading-relaxed">
            ...
            <em>to go with</em> is key to understanding this. Cards are said to
            go with another card when they form a straight. Since Aces cannot
            form a straight, the cards that go with an Ace are those that form a
            trio.
          </p>
        </div>
      </div>

      {/* Payout Conditions Table */}
      <div className="bg-white/60 border border-stone-300 rounded-xl overflow-hidden mb-14 backdrop-blur-sm shadow-sm">
              ...
              <div>
                <p
                  className={`text-sm font-bold ${
                    item.faded ? "text-stone-400" : "text-stone-800"
                  }`}
                >
                  {item.label}
                </p>
                <p
                  className={`text-xs ${
                    item.faded ? "text-stone-400" : "text-stone-500"
                  } leading-relaxed`}
                >
                  {item.desc}
                </p>
      ...
      <div className="bg-stone-800 text-stone-100 rounded-2xl p-8 sm:p-12 mb-14 shadow-2xl relative overflow-hidden">
        <div className="flex flex-col lg:flex-row gap-12 items-center relative z-10">
          <div className="flex-1">
            <p className="text-[10px] font-black tracking-[0.2em] uppercase mb-3 text-stone-400">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-[#E06A7D] flex items-center justify-center shrink-0 font-bold text-white">
                  1
                </div>
                <p className="text-stone-300 text-sm leading-relaxed">
                  A <strong>4 of Copas</strong> is discarded to your left. You
                  pick it up as your <strong>last card (Bunot)</strong> to
                  complete your bahay.
                </p>
              </div>
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-stone-700 flex items-center justify-center shrink-0 font-bold text-white">
                  2
                </div>
                <p className="text-stone-300 text-sm leading-relaxed">
                  Check for the <strong>Bunot Bonus</strong>: You hold the 3 and
                  5 of Copas. Since they form a straight with your last card,
                  you earn <strong>60¢</strong>.
                </p>
              </div>
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-stone-700 flex items-center justify-center shrink-0 font-bold text-white">
                ...
                <p className="text-stone-300 text-sm leading-relaxed">
                  Check for the <strong>Sowee Bonus</strong>: The sowee card is
                  a 5 of Espadas. You hold the 3 and 4 of Espadas. This matches
                  the sowee, earning you <strong>70¢</strong>.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full lg:w-80 flex flex-col items-center gap-6 p-8 bg-stone-700/30 rounded-xl border border-stone-600">
            <p className="text-[10px] font-black tracking-widest uppercase text-stone-500">
              The Winning Card
            </p>
            <CuajoCard
              suit="Copas"
              value="4"
              className="!w-24 sm:!w-28 md:!w-32 shadow-2xl ring-4 ring-[#E06A7D] ring-offset-4 ring-offset-stone-800"
            />
            <div className="text-center">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="p-8 bg-white/60 border border-stone-300 rounded-xl shadow-sm">
          ...
          <h4 className="text-2xl font-serif italic mb-6 text-stone-800">
            Haris (Kings)
          </h4>
          <div className="grid grid-cols-2 gap-4">
            <div className="p-5 bg-white border border-stone-200 rounded-xl shadow-sm text-center">
              ...
              <p className="text-[9px] text-stone-400 uppercase mt-2">
                Bonus Payout
              </p>
            </div>
            <div className="p-5 bg-white border border-stone-200 rounded-xl shadow-sm text-center">
        ...
        <div className="p-8 bg-[#1a1a1a] text-white rounded-xl shadow-2xl relative overflow-hidden flex flex-col justify-center">
          ...
          <p className="text-[10px] font-black tracking-[0.2em] uppercase mb-2 text-stone-500">
            Super Rare Win
          </p>
          <h4 className="text-3xl font-serif italic mb-4 text-[#E06A7D]">
            Porbis
          </h4>
          <p className="text-stone-400 text-sm leading-relaxed mb-6">
            Awarded if you win with <strong>no Haris</strong> at all, or exactly
            one Hari used strictly in a special straight. This is rare because
